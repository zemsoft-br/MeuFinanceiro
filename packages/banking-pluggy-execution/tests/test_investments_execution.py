...
class FakeStore:
    ...
    credentials: EnabledProviderCredentials = field(default_factory=_enabled_credentials)
...
def test_contextual_investment_read_uses_local_connection_and_closes_transport() -> None:
