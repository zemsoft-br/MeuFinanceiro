...
def upgrade() -> None:
    ...
    op.execute(
        ...
        CREATE TABLE integrations.external_observations (
            ...
            CONSTRAINT ck_external_observations_resource CHECK (resource_type = 'transactions'),
            ...
            CONSTRAINT ck_external_observations_currency CHECK (currency ~ '^[A-Z]{3}$'),
    ...
    op.execute("ALTER TABLE integrations.external_observations ENABLE ROW LEVEL SECURITY")
    op.execute("ALTER TABLE integrations.external_observations FORCE ROW LEVEL SECURITY")
