...
- `screens/`: 62 capturas PNG originais e válidas;
...
As capturas preservam os PNGs válidos byte a byte. O ZIP bruto completo e os HTMLs gerados não são código-fonte do produto.
