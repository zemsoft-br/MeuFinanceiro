...
void main() {
  test('reauthentication uses only local UUID path and returns single-use material', () async {
  ...
  test('reauthentication response is strict and validates provider item ID', () async {
    for (final body in [
