...
void main() {
  testWidgets('protected reauthentication deep link resumes after login', (
    tester,
  ) async {
    ...
    final location = AppRoutes.pluggyReauthenticationLocation(_connectionId);
    ...
    expect(find.byKey(PluggyReauthenticationScreen.titleKey), findsNothing);
    ...
    expect(find.textContaining(_connectionId), findsNothing);
