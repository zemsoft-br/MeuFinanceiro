...
from app.api.routes.banking_reauthentication import router as banking_reauthentication_router
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    async def lifespan(app: FastAPI) -> AsyncIterator[None]:
        ...
        banking_pluggy_reauthentication: PluggyReauthenticationTokenService | None = None
        if (
    ...
    application.include_router(banking_reauthentication_router, prefix="/api/v1")
